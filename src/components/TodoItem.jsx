...
import { Trash2, GripVertical, Calendar, AlertCircle, Edit, Tag } from 'lucide-react';
...
export function TodoItem({ todo, onEdit, isDragging }) {
  ...
  const daysUntilDue = Math.ceil(
    (new Date(todo.dueDate).getTime() - new Date().getTime()) / (1000 * 3600 * 24)
  );
