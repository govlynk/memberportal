...
export default function CompanyUpdateForm(props) {
  ...
  const [legalBusinessName, setLegalBusinessName] = React.useState(
    initialValues.legalBusinessName
  );
  ...
  const [companyPhoneNumber, setCompanyPhoneNumber] = React.useState(
    initialValues.companyPhoneNumber
  );
  ...
  const resetStateValues = () => {
    const cleanValues = companyRecord
      ...
      : initialValues;
    setLegalBusinessName(cleanValues.legalBusinessName);
    setDbaName(cleanValues.dbaName);
    setUei(cleanValues.uei);
    setCageCode(cleanValues.cageCode);
    setEin(cleanValues.ein);
    setCompanyEmail(cleanValues.companyEmail);
    setCompanyPhoneNumber(cleanValues.companyPhoneNumber);
    setCompanyWebsite(cleanValues.companyWebsite);
  ...
  return (
    ...
    >
      <TextField
        ...
        onBlur={() =>
          runValidationTasks("legalBusinessName", legalBusinessName)
        }
      ...
      <TextField
        ...
        onBlur={() =>
          runValidationTasks("companyPhoneNumber", companyPhoneNumber)
        }
