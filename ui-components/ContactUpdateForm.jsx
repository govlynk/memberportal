...
export default function ContactUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setContactMobilePhone(cleanValues.contactMobilePhone);
    setContactBusinessPhone(cleanValues.contactBusinessPhone);
    setWorkAddressStreetLine1(cleanValues.workAddressStreetLine1);
    setWorkAddressStreetLine2(cleanValues.workAddressStreetLine2);
    setWorkAddressCity(cleanValues.workAddressCity);
    setWorkAddressStateCode(cleanValues.workAddressStateCode);
    setWorkAddressZipCode(cleanValues.workAddressZipCode);
    setWorkAddressCountryCode(cleanValues.workAddressCountryCode);
    setDateLastContacted(cleanValues.dateLastContacted);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          contactBusinessPhone: contactBusinessPhone ?? null,
          workAddressStreetLine1: workAddressStreetLine1 ?? null,
          workAddressStreetLine2: workAddressStreetLine2 ?? null,
          workAddressCity: workAddressCity ?? null,
          workAddressStateCode: workAddressStateCode ?? null,
          workAddressZipCode: workAddressZipCode ?? null,
          workAddressCountryCode: workAddressCountryCode ?? null,
          dateLastContacted: dateLastContacted ?? null,
          notes: notes ?? null,
        };
